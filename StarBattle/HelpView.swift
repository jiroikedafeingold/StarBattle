            ...
            List {
                ...
                Section("Credits") {
                    VStack(alignment: .leading, spacing: 8) {
                        Text("Cherry Battle is a friendly take on **Star Battle**, the classic logic puzzle invented by **Hans Eendebak**. All credit for the original puzzle design goes to him.")
